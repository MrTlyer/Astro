---
title: cf pages部署docker pull 代理
description: docker部署
publishDate: 2025-03-31
tags:
  - docker、cloudflare、istoreOS
...
需要注册一个cloudflare账号,可以没有域名，pages部署可以使用dynv6.com免费域名，那么**自定义域名代理地址**将是一个如 xxxx.xxx.dynv6.net的三级域名
...
/**
 1. 代理请求
 2. @param {URL} urlObj URL对象
 3. @param {RequestInit} reqInit 请求初始化对象
 4. @param {string} rawLen 原始长度
 */
...
如果是istoreOS 软路由系统，可以进入后台docker的配置菜单下面，直接添加注册表镜像`xxxx.xxx.dynv6.net`就可以直接使用了，不用加前缀也可以直接拉取镜像。
